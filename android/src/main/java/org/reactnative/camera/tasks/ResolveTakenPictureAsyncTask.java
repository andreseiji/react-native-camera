...
public class ResolveTakenPictureAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        if (mOptions.hasKey("skipProcessing")) {
            try {
                ...
                FirebaseVisionImageMetadata metadata = new FirebaseVisionImageMetadata.Builder()
                    ...
                    .setRotation(getFirebaseRotation(getImageRotation(mOptions.hasKey("orientation") ? mOptions.getInt("orientation") : mDeviceOrientation)))
                    .build();
                FirebaseVisionImage fbImage = FirebaseVisionImage.fromByteArray(mImageData, metadata);
                final FirebaseVisionFaceDetector fbDetector = FirebaseVision.getInstance()
    ...
    private int getFirebaseRotation(int rotation){
      int result;
      switch (rotation) {
        case 0:
        ...
        default:
          result = FirebaseVisionImageMetadata.ROTATION_0;
          Log.e(ERROR_TAG, "Bad rotation value: " + rotation);
      }
      return result;
    }
